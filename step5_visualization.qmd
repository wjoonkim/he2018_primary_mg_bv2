...
load("intermediate/deg_objects.RData")
...
```{r}
# Save objects for functional analysis
save(res_table_shrunken_label_gene_tb, ens2gene, file = "intermediate/step5_objects.RData")
```