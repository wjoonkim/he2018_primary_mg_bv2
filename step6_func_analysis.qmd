...
load("intermediate/step5_objects.RData")  # res_table_shrunken_label_gene_tb, ens2gene

# Load mouse_ens from step2
library(AnnotationHub)
library(ensembldb)
ah <- AnnotationHub()
mouse_ens <- query(ah, c("Mus musculus", "EnsDb"))[["AH119358"]]
```
